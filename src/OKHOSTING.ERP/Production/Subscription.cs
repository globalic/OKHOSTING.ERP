...
namespace OKHOSTING.ERP.Production
{
	...
	public class Subscription: ProductInstance
	{
		...
		//	ICollection<InvoiceItem> items = new ICollection<InvoiceItem>(Session, CriteriaOperator.And(new BinaryOperator("Description", item.Description), new BinaryOperator("Product.ProductInstanceType", item.Product.ProductInstanceType)));
		...
		//	if (soldTo == null)
		//	{
		//		return new ICollection<Subscription>(MyApplication.XpoSession, CriteriaOperator.And(new BinaryOperator("End", from, BinaryOperatorType.GreaterOrEqual), new BinaryOperator("End", to, BinaryOperatorType.LessOrEqual)));
		//	}
		//	else
		//	{
		//		return new ICollection<Subscription>(MyApplication.XpoSession, CriteriaOperator.And(new BinaryOperator("End", from, BinaryOperatorType.GreaterOrEqual), new BinaryOperator("End", to, BinaryOperatorType.LessOrEqual), new BinaryOperator("SoldTo", soldTo), new BinaryOperator("Product", (object) null, BinaryOperatorType.NotEqual)));
		//	}
		//}
		...
		//	if (soldTo == null)
		//	{
		//		return new ICollection<Quote>(MyApplication.XpoSession, CriteriaOperator.And(new BinaryOperator("Date", from, BinaryOperatorType.GreaterOrEqual), new BinaryOperator("Date", to, BinaryOperatorType.LessOrEqual)));
		//	}
		//	else
		//	{
		//		return new ICollection<Quote>(MyApplication.XpoSession, CriteriaOperator.And(new BinaryOperator("Date", from, BinaryOperatorType.GreaterOrEqual), new BinaryOperator("Date", to, BinaryOperatorType.LessOrEqual), new BinaryOperator("SoldTo", soldTo)));
		//	}
		//}
		...
		//{
		//	ICollection<Customer> customers = new ICollection<Customer>(MyApplication.XpoSession);
		...
		//protected bool IsFirstItem(InvoiceItem item)
		//{
		...
		//protected bool IsLastItem(InvoiceItem item)
		//{
		//	if (item.ProductInstance != this)
		//	{
		//		throw new ArgumentException("Item should belong to Items collection", "item");
		...
		///// </summary>
		//protected bool IsUpgrade(InvoiceItem item)
		//{
		//	if (item.ProductInstance != this)
		//	{
		//		throw new ArgumentException("Item should belong to Items collection", "item");
